...
One can position the Cosmos view using Auto Layout constaints. The width and height of the view is determined automatically based on the size of the stars and text. Therefore, there is no need to set width/height constaints on the Cosmos view.
