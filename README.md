...
This is a UI control for iOS that shows a star rating or takes rating input from the user. Cosmos is a subclass of a UIView that will allow your users post those inescapable 1-star reviews!
...
1) Add `View` control into your storyboard.
...
2) Set its class to `CosmosView` in the *identity inspector*. Set its *module* property to `Cosmos` if you used Carthage or CocoaPods setup methods.
